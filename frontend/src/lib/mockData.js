...
export const MOCK_CATALOG = [
  ...
  { id: 6, category: 'foreplay', title: 'Talk It Out', description: 'Say what you want before you do it. Be bold.', emoji: '🗣️', tier: 'quick' },
  ...
  { id: 8, category: 'foreplay', title: 'Mirror Play', description: 'Watch each other. Show them exactly what you like.', emoji: '👀', tier: 'standard' },
  ...
  { id: 18, category: 'positions', title: 'Both at Once', description: 'Both giving and receiving at the same time. Teamwork.', emoji: '🔄', tier: 'standard' },
  ...
  { id: 22, category: 'positions', title: 'Legs Up', description: 'Deep, intense, good stretch. Eye contact optional.', emoji: '🦵', tier: 'standard' },
  { id: 23, category: 'positions', title: 'Facing Away', description: 'Different angle, different sensation entirely.', emoji: '🔀', tier: 'standard' },
  { id: 24, category: 'positions', title: 'Lying Flat', description: 'Face down. Full body pressure and closeness.', emoji: '⬇️', tier: 'standard' },
  ...
  { id: 39, category: 'roleplay', title: 'Massage Therapist', description: 'Professional at first. Then the boundaries blur.', emoji: '💆', tier: 'standard' },
  ...
  { id: 43, category: 'roleplay', title: 'Photographer', description: 'One poses, the other shoots. Playful or intense.', emoji: '📸', tier: 'standard' },
  ...
  { id: 49, category: 'toys-gear', title: 'Soft Ties', description: 'Scarves, ribbons, or proper cuffs. Trust and surrender.', emoji: '🔗', tier: 'standard' },
  ...
  { id: 55, category: 'toys-gear', title: 'Warming Lubricant', description: 'Adds a slow heat that builds. Small change, big difference.', emoji: '🌡️', tier: 'quick' },
  ...
  { id: 58, category: 'adventurous', title: 'Light Restraint', description: 'Wrists, ankles. Soft and safe. Trust is the point.', emoji: '🎗️', tier: 'standard' },
  ...
  { id: 60, category: 'adventurous', title: 'Sensation Play', description: 'Wax, ice, scratching — mix contrasts carefully.', emoji: '⚡', tier: 'standard' },
  ...
  { id: 62, category: 'adventurous', title: 'Read Stories Together', description: 'Pick a steamy story. Read it aloud. See where it leads.', emoji: '📕', tier: 'quick' },
  ...
  { id: 65, category: 'adventurous', title: 'New Room', description: 'Somewhere in the house you haven\'t tried yet.', emoji: '🚪', tier: 'quick' },
  { id: 66, category: 'adventurous', title: 'Marathon Session', description: 'Clear the whole afternoon. No phone, no plans.', emoji: '🏔️', tier: 'splurge' },
  { id: 67, category: 'adventurous', title: 'Surprise Initiation', description: 'Start something when they least expect it.', emoji: '💥', tier: 'quick' },
  { id: 68, category: 'adventurous', title: 'Fantasy Sharing', description: 'Take turns describing a fantasy. No judgment.', emoji: '💭', tier: 'quick' },
];
